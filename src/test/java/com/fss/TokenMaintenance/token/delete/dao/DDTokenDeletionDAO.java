...
public class DDTokenDeletionDAO {
	...
	@Test
	public void testTokenDeleteDaoPos(@Param(name="TokenId")String tokenId) {
		assertTrue(tokenMaintenanceDAO.deleteToken(tokenId));
	}
	
	@Test
	public void testTokenDeleteDaoNeg(@Param(name="TokenId")String tokenId) {
		assertTrue(!tokenMaintenanceDAO.deleteToken(tokenId));
	}
